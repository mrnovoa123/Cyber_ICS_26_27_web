/* MP5021 — Manual Vagrant (alumnado) */
const MANUAL = {
 "files": {
 ...
 "per": [
  {
   ...
   "note": "El fichero <code>wazuh-passwords.txt</code> contiene las credenciales del laboratorio: no lo compartas ni lo subas a ningún repositorio."
  },
  {
   "n": "srvweb",
   ...
   "note": "DVWA es una aplicación vulnerable a propósito: solo debe estar accesible dentro de la red del laboratorio."
  },
  {
   "n": "win10",
 ...
 "e2e": [
  ...
  [
   ...
   "Wazuh registra las autenticaciones fallidas y la alerta de fuerza bruta SSH en <code>srvweb</code>"
  ]
 ],
